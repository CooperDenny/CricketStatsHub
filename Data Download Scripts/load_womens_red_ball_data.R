...
for(i in 1:nrow(tournaments)){
  ...
  write.csv(match_batting, paste0("Database/",tournaments$competition[i],"\\",tournaments$code[i],"_match_batting_women.csv"), row.names=FALSE)
  ...
  write.csv(match_bowling, paste0("Database/",tournaments$competition[i],"\\",tournaments$code[i],"_match_bowling_women.csv"), row.names=FALSE)
  ...
  print(tournaments$competition[i])
